...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT DISTINCT o FROM Order o JOIN FETCH o.table LEFT JOIN FETCH o.user LEFT JOIN FETCH o.items i LEFT JOIN FETCH i.menuItem WHERE o.createdAt >= :start AND o.createdAt <= :end ORDER BY o.createdAt DESC")
    List<Order> findAllByCreatedAtBetween(@Param("start") java.time.LocalDateTime start, @Param("end") java.time.LocalDateTime end);
